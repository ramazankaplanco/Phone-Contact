...
namespace PhoneContact
{
    ...
    public class ApplicationUserManager : UserManager<User, int>
    {
        ...
        public static async Task<ClaimsIdentity> GenerateUserIdentityAsync(User user, ApplicationUserManager manager)
        {
    ...
    public class ApplicationSignInManager : SignInManager<User, int>
    {
        ...
        {
            return ApplicationUserManager.GenerateUserIdentityAsync(user, (ApplicationUserManager)UserManager);
        }
